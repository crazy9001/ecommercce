...
if (strpos($real_path . $upload_path, 'public' . $upload_path) === false) {
    $real_path = $real_path . '/public';
}
$opts = array(
    // 'debug' => true,
    'roots' => array(
        array(
            ...
            'path'          => $real_path . $upload_path, // path to files (REQUIRED)
            'URL'           => $upload_path, // URL to files (REQUIRED)
