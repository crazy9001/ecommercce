        ...
        start = function(CKEDITOR, elFinder) {
            ...
            $(function() {
                var elfNode, elfInsrance, dialogName,
                    elfUrl = '/assets/plugins/elfinder/php/connector.minimal.php', // Your connector's URL
                    elfDirHashMap = { // Dialog name / elFinder holder hash Map
                        image : '', // for example to 1st LocalFileVolume : `/CKE_Imgs`
                        flash : '',
                        files : '',
                        link  : '',
                        fb    : 'l1_Lw' // Fall back target : `/`
                    },
                    imgShowMaxSize = 500, // Max image size(px) to show
                    customData = {},
                ...
                //     filebrowserUploadUrl: '/assets/plugins/elfinder/php/connector.minimal.php',
                //     imageUploadUrl: '/assets/plugins/elfinder/php/connector.minimal.php'
                // });
